...
export class HotelRepository {
    ...
    hotelsAvailables: Hotel[] = [
        new Hotel(1, "Four seasons", 5, "Recoleta", "https://cdn.bestday.net/_lib/vimages/Buenos-Aires-Argentina/Hotels/Four-Seasons-Buenos-Aires-Hotel/fachada_g.jpg", fourSeasonTypes, extraServices),
        new Hotel(2, "Las Hayas Resort", 5, "Usuahia", "https://cdn.bestday.net/_lib/vimages/Ushuaia-Argentina/Hotels/Las-Hayas-Resort-Hotel/fachada_g.jpg", lasHayasTypes, extraServices),
        ...
        new Hotel(4, "Hosteria La Caldera", 4, "Salta", "https://q-xx.bstatic.com/xdata/images/hotel/max500/10150270.jpg?k=2f7ca75d2677038eb55fb54e8d76593f492fe6ad28b7d628da57b21d1c3b6a1b&o=", laCarderaTypes, extraServices),
        new Hotel(5, "Tierra Colorada", 2, "Puerto Iguazu", "https://media-cdn.tripadvisor.com/media/photo-s/03/2f/3d/c9/hotel-tierra-colorada.jpg", tierraColoradaTypes, extraServices),
        ...
        new Hotel(7, "Winter Suites", 5, "Bariloche", "https://x.cdrst.com/foto/hotel-sf/80d1/granderesp/winter-suites-exterior-e69ad8.jpg", winterSuitesTypes, extraServices),
    ]
